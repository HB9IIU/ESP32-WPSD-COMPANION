...
\033[0m
                 ...
                 \033[1;35mESP32 CYD HOTSPOT COMPANION\033[0m

              \033[1;32mCONNECT\033[0m  •  \033[1;33mMONITOR\033[0m  •  \033[1;36mDISPLAY\033[0m

  ┌──────────────────────────────────────────────────────────────┐
  │                                                              │
  │   WPSD / MMDVMHost                                           │
  │                                                              │
  │    ├─ reads: /var/log/pi-star/MMDVM-*.log                    │
  │    ├─ reads: /etc/mmdvmhost                                  │
  │    │                                                         │
  │    └─ monitor_mmdvm_ws.py  \033[1;32m(WebSocket :8765)\033[0m              │
  │                                │                              │
  │                                ▼                              │
  │                         ESP32 CYD TFT                         │
  │                         LIVE REMOTE DISPLAY                   │
  ...
  └──────────────────────────────────────────────────────────────┘
                    ...
                    \033[1;35mWebSocket Bridge Installer\033[0m
                             \033[1;36mby HB9IIU\033[0m
